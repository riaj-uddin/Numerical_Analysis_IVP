...
headings = {'x', 'RK-2 Method', 'Exact Solution', 'Error', 'Error (%)'};

% Write the matrix to a CSV file
outputFile = 'rk2_example_2.csv';
...
ylabel('y');
grid on;
title('RK-2 Method vs Exact Solution of dy/dx=1+(y/x)+(y/x)^2');
legend("RK-2 Method", 'Exact Solution', 'Location', 'best');
set(gca, 'FontSize', 20)